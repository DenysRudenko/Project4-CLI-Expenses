...
| Feuture | Users | Functionality | Style | Outcome | Pass/Fail |
| -------------- | -------------- | -------------- | -------------- | -------------- | -------------- |
| Prefered Currency | Registered | Allows user to choose which currency needed for expenses/incomes | Styled | User can choose the currency for expenses/incomes in his wallet | <span style="color:green">Pass</span> |
| Save Button | Registered | Save the currency | Styled | Save the currency to your wallet, whole list of expenses/incomes will displayed in current currency | <span style="color:green">Pass</span> |

#### Expenses/Incomes Chart Page

| Feuture | Users | Functionality | Style | Outcome | Pass/Fail |
| -------------- | -------------- | -------------- | -------------- | -------------- | -------------- |
| Rent | Registered | Chart for Rent category | <span style="color:yellow">Yellow</span> | Displayed the summary value for rent category | <span style="color:green">Pass</span> |
| Insurance | Registered | Chart for Insurance category | <span style="color:blue">Blue</span> | Displayed the summary value for Insurance category | <span style="color:green">Pass</span> |
| Family | Registered | Chart for Family category | <span style="color:aqua">Aqua</span> | Displayed the summary value for Family category | <span style="color:green">Pass</span> |
| Travel | Registered | Chart for Travel category | <span style="color:purple">Purple</span> | Displayed the summary value for Travel category | <span style="color:green">Pass</span> |
| Restaurants | Registered | Chart for Restaurants category | <span style="color:orange">Orange</span> | Displayed the summary value for Restaurants category | <span style="color:green">Pass</span> |
| Friends | Registered | Chart for Friends category | <span style="color:red">Red</span> | Displayed the summary value for Friends category | <span style="color:green">Pass</span> |
